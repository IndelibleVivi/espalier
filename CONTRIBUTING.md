...
Run the narrow relevant test while implementing, then the complete gate appropriate to the affected contract. Rendered Web changes additionally need real browser inspection at desktop and mobile widths, meaningful DOM, console health, target-flow interaction, keyboard/accessibility evidence, and non-color semantic review.
